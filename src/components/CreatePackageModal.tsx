...
// }
//
// export default function CreatePackageModal({onClose, onSubmit}: Props) {
//     const {data: services = []} = useAllServices();
//
//     const [name, setName] = useState("");
//     const [shortDescription, setShortDescription] = useState(""); // Added field
...
//
//     return (
//         <Modal title="Create New Package" onClose={onClose}
//                actionButton={{label: "Create Package", onClick: handleSubmit}}>
...
//                         placeholder="e.g. Complete exterior wash + wax"
//                     />
//                 </div>
//
//                 <div>
...
//                         placeholder="List specific details..."
//                     />
//                 </div>
//
//                 {/* Service Selection */}
...
//                     <div
//                         className="border border-gray-200 rounded-xl max-h-48 overflow-y-auto p-2 bg-white/50 space-y-1">
...
//                                 </div>
//                                 <div
//                                     className="text-sm font-semibold text-gray-700">LKR {Number(svc.base_price).toLocaleString()}</div>
//                             </div>
//                         ))}
//                     </div>
//                 </div>
...
export default function CreatePackageModal({ onClose, onSubmit, initialData }: Props) {
    ...
    useEffect(() => {
        if (initialData) {
            ...
            // Extract IDs from the 'services' array included in the package object
