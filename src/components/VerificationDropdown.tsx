...
export default function VerificationDropdown({
    ...
    const isDropdown = !!options && !!onChange;
            ...
            <div className="relative">
                ...
                {isDropdown ? (
                    <select
                        ...
                        // className={`w-full ${
                        //     isIcon ? "pl-10" : "pl-4"
                        // } pr-10 py-4 rounded-3xl bg-white/80 backdrop-blur text-sm focus:outline-none focus:ring-2 focus:ring-red-700 appearance-none`}
                        className={`w-full ${
                            isIcon ? "px-10" : "px-4"
                        } py-4 rounded-3xl bg-white/80 backdrop-blur text-sm placeholder-[#575757] focus:outline-none focus:ring-2 focus:ring-red-700 appearance-none`}
                    >
