...
export default function DetailsModal({
    ...
    return createPortal(
        ...
        >
            ...
            {/* Modal box */}
            <div
                className="relative max-w-[1400px] min-w-[756px] min-h-[274px] rounded-[45px] border border-[#E7E7E7] backdrop-blur-[60px] bg-[#FFFFFF]/80 shadow-lg px-8 py-6 z-10 flex flex-col"
