      ...
      <section className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] border border-[#E0E0E0] px-14 py-10 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <div className="space-y-1">
            <p className="font-semibold text-[24px] max-[1140px]:text-[20px] leading-[100%] tracking-normal text-[#1D1D1D]">
              Welcome Back, {name}
            </p>
        ...
        <div className="flex items-center space-x-20">
          <div className="flex flex-col space-y-1">
            <span className="font-normal text-[30px] max-[1140px]:text-[25px] max-[1140px]:text-center leading-[100%] uppercase text-black">
              WEDNESDAY
            </span>
          ...
          <span className="font-medium text-[20px] max-[1140px]:text-[13px] leading-[100%] tracking-[0.34em] uppercase text-black">
            01:06:03 PM
          </span>
        </div>
      </section>
