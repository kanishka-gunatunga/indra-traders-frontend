...
export default function Header({
    ...
    return (
        <>
            ...
            {/* Welcome Card */}
            <section
                className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] border border-[#E0E0E0] px-14 py-10 flex justify-between items-center">
                {/* Left Side - Welcome */}
            ...
            <span
                className="font-normal text-[30px] max-[1140px]:text-[25px] max-[1140px]:text-center leading-[100%] uppercase text-[#1D1D1D]">
              {day}
            </span>
                        <span
                            className="font-normal text-[15px] max-[1140px]:text-[10px] max-[1140px]:text-center leading-[100%] tracking-[0.39em] uppercase text-black">
              {date}
            </span>
                    </div>
                    <span
                        className="font-medium text-[20px] max-[1140px]:text-[13px] leading-[100%] tracking-[0.34em] uppercase">
            {time}
          </span>
                </div>
            </section>
