...
//                     <div className="bg-[#DB2727] text-white text-[10px] px-2 py-1 rounded-md w-[90%] truncate text-center shadow-sm">
//                         {match.reason}
//                     </div>
//                 </div>
//             );
...
//
//                 <section className="bg-[#FFFFFF4D] border border-[#E0E0E0] rounded-[45px] p-8 shadow-sm ml-16">
//                     <h2 className="font-semibold text-[22px] mb-6 text-[#DB2727]">3. Unavailable Dates</h2>
...
//                         Cancel
//                     </button>
//                     <button onClick={handleSubmit} disabled={createBranchMutation.isPending}
...
//                         {createBranchMutation.isPending ? "Creating..." : (<>Save</>)}
//                     </button>
//                 </div>
//             </main>
//
...
//                     footer={[
//                         editingDateId && (
//                             <button key="delete" onClick={handleDeleteDate} className="mr-auto text-red-600 hover:text-red-800 font-medium px-4">
//                                 <Trash2 size={16} className="inline mr-1"/> Remove
//                             </button>
//                         ),
//                         <button key="cancel" onClick={() => setIsDateModalVisible(false)} className="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg mr-2">
//                             Cancel
//                         </button>,
//                         <button key="submit" onClick={handleSaveDate} className="px-6 py-2 bg-[#DB2727] text-white rounded-lg hover:bg-red-700">
//                             Save
//                         </button>
//                     ]}
//                 >
...
import { useRouter } from "next/navigation";
import { useCreateBranch } from "@/hooks/useServicePark";
import { useToast } from "@/hooks/useToast";
import Toast from "@/components/Toast";
