...
export default function ServiceParkLoginPage() {
  ...
  const branches = [
    { id: 15, name: "Indra Service Park (Default)" },
    { id: 1, name: "Colombo Service Park" },
    { id: 2, name: "Gampaha Service Park" },
    { id: 3, name: "Kandy Service Park" }
  ];
        ...
        <div className="relative z-10 bg-[#EEEAE9] w-[450px] rounded-[40px] p-10 shadow-xl border border-white/50 transition-transform duration-300">
          ...
          <form className="space-y-6 flex flex-col items-center" onSubmit={handleLogin}>
            <div className="space-y-2 relative w-[352px]" ref={dropdownRef}>
              ...
              >
                <span className="montserrat text-[14px] text-[#1D1D1D] font-normal leading-none">{selectedBranch.name}</span>
            ...
            >
              ...
              <span className="font-semibold text-[16px] leading-[24px] text-center montserrat text-white">{loading ? "Signing in..." : "Sign In to Dashboard"}</span>
            </button>
          </form>
