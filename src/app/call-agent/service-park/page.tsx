                    ...
                    <main className="pt-30 px-16 ml-16 max-w-[1440px] mx-auto flex flex-col gap-8">
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-black">
                                        ...
                                        <tr className="text-lg font-medium justify-between text-[#1D1D1D] space-y-2">
                                            ...
                                            <td className="py-4 px-4 text-right text-[#1D1D1D] font-semibold">LKR
                                                112,000
                                            </td>
                                        </tr>
                                        ...
                                        <tr className="border-t-1 border-[#575757]">
                                            <td className="py-4 px-4 font-bold text-xl text-[#DB2727] mt-8">Final
                                                Estimate
                                                Price
                                            </td>
                        ...
                        <section
                            ...
                            <form className="flex flex-col">
                                ...
                                {/*{submitSuccess && (*/}
                                {/*    <div className="text-green-600 text-sm mt-4">Vehicle sale created*/}
                                {/*        successfully!</div>*/}
                                {/*)}*/}
                            </form>
                        </section>
