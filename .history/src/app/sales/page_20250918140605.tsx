...
export default function SalesDashboard() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#E6E6E6B2]/70 backdrop-blur-md text-gray-900 montserrat overflow-x-hidden flex flex-col justify-center">
      <main className="pt-30 px-4 md:px-16 ml-0 md:ml-16 max-w-[1440px] mx-auto flex flex-col gap-8">
