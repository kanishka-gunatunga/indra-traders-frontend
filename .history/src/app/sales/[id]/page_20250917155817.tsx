      ...
      <main className="pt-30 px-16 ml-16 max-w-[1440px] mx-auto flex flex-col gap-8">
        ...
        <section className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] px-9 py-10 flex flex-col justify-center items-center">
          ...
          <div className="w-full flex">
            <div className="w-2/5">
              <span className=" font-semibold text-[20px] leading-[100%] tracking-[0%]">
                Customer Details
              </span>
              <div className="mt-8 flex w-full gap-3">
                <div className=" w-1/3 font-medium text-[#1D1D1D] text-[18px] leading-[100%] tracking-[0%]">
                  Customer Name:
                </div>

                <div className="w-2/3 font-medium text-[18px] text-[#575757] leading-[100%] tracking-[0%]">
                  Emily Charlotte
                </div>
              </div>
              <div className="mt-3 flex w-full gap-3">
                <span className=" font-medium text-[#1D1D1D] text-[18px] leading-[100%] tracking-[0%]">
                  Contact No:
                </span>

                <span className=" font-medium text-[18px] text-[#575757] leading-[100%] tracking-[0%]">
                  077 5898712
                </span>
              </div>
              <div className="mt-3 flex w-full gap-3">
                ...
                <span className="w-2/3 font-medium text-[18px] text-[#575757] leading-[100%] tracking-[0%]">
                  Info@indra.com
                </span>
              </div>
            </div>
