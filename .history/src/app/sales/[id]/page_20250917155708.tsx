        ...
        <section className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] px-9 py-10 flex flex-col justify-center items-center">
          ...
          <div className="w-full flex">
            <div className="w-2/5">
              ...
              <div className="mt-8 flex wf gap-3">
                <div className=" w-1/2 font-medium text-[#1D1D1D] text-[18px] leading-[100%] tracking-[0%]">
                  Customer Name:
                </div>

                <div className="w-1/2 font-medium text-[18px] text-[#575757] leading-[100%] tracking-[0%]">
                  Emily Charlotte
                </div>
              </div>
