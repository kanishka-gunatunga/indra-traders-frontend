      ...
      <main className="pt-30 px-16 ml-16 max-w-[1440px] mx-auto flex flex-col gap-8">
        ...
        <section className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] px-9 py-10 flex flex-col justify-center items-center">
          <div className="flex w-full justify-between">
            ...
            {/* Flow bar */}
            <div className="w-[786px] h-[50px] flex rounded-[30px] bg-[#C0C0C0] overflow-hidden">
              {/* Step 1: New */}
              <div
                className="flex-1 bg-[#DB2727] flex items-center justify-center border-r-2 border-white text-white font-semibold text-[16px]"
                style={{
                  clipPath:
              ...
              {/* Step 3: Won/Lost */}
              <div className="flex-1 bg-[#C0C0C0] flex items-center justify-center text-white font-semibold text-[16px]">
                Won/Lost
              </div>
            </div>
          </div>
