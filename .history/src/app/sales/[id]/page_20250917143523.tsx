        ...
        <section className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] px-9 py-10 flex flex-col justify-center items-center">
          <div className="flex w-full justify-between">
            ...
            <div className="w-[786px] h-[50px] flex rounded-[30px] overflow-hidden">
              {/* Step 1: New */}
              <div
                className="flex-1 bg-[#FF6B6B] flex items-center justify-center text-white font-semibold text-[16px]"
                style={{
                  clipPath:
              ...
              {/* Step 2: Ongoing */}
              <div
                className="flex-1 bg-[#FFA94D] flex items-center justify-center text-white font-semibold text-[16px]"
                style={{
                  clipPath:
                    "polygon(0 0, calc(100% - 20px) 0, 100% 50%, calc(100% - 20px) 100%, 0 100%)",
                }}
