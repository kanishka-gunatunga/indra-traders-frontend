          ...
          <div className="flex w-full justify-between">
            ...
            <div className="w-[786px] h-[50px] flex rounded-[30px] overflow-hidden bg-[#C0C0C0]">
              ...
              <div className="relative flex-1">
                <div
                  className="absolute top-0 left-0 h-full bg-[#DB2727] flex items-center justify-center text-white font-semibold text-[16px] rounded-l-[30px]"
                  style={{
                    width: "calc(100% - 4px)", // leave 4px space
                    clipPath:
              ...
              <div className="relative flex-1">
                <div
                  className="absolute top-0 left-0 h-full bg-[#C0C0C0] flex items-center justify-center text-white font-semibold text-[16px]"
                  style={{
                    width: "calc(100% - 4px)", // same 4px space
                    clipPath:
                      "polygon(0 0, calc(100% - 20px) 0, 100% 50%, calc(100% - 20px) 100%, 0 100%)",
                  }}
                >
