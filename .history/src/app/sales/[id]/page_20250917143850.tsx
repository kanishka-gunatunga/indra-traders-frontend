  ...
  return (
    <div className="relative w-full min-h-screen bg-[#E6E6E6B2]/70 backdrop-blur-md text-gray-900 montserrat overflow-x-hidden">
      ...
      <div className="relative flex-1">
        ...
        <div
          className="absolute inset-0 bg-[#DB2727] flex items-center justify-center text-white font-semibold text-[16px]"
          style={{
            clipPath:
        ...
        {/* White border arrow on top */}
        <div
          className="absolute inset-0"
          style={{
            clipPath:
              "polygon(calc(100% - 22px) 0, 100% 50%, calc(100% - 22px) 100%)",
            background: "white",
            width: "22px",
          }}
        />
