      ...
      <main className="pt-30 px-16 ml-16 max-w-[1440px] mx-auto flex flex-col gap-8">
        ...
        <section className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] px-9 py-10 flex flex-col justify-center items-center">
          ...
          <div className="w-full flex">
            <div className="w-2/5">
              <span className="font-montserrat font-semibold text-[20px] leading-[100%] tracking-[0%]">
                Customer Details
              </span>
              <div className="mt-3 flex gap-3">
                <span className="font-montserrat font-medium text-[18px] leading-[100%] tracking-[0%]">
  Customer Name:
</span>
