    ...
    <div className="flex space-x-0">
      ...
      <div className="relative w-[270px] h-[58px]">
        ...
        >
          ...
          <path d="M33 4V54H29C15.1929 54 4 42.8071 4 29C4 15.1929 15.1929 4 29 4H33Z" fill="#DB2727"/>
          <path d="M33 10V48C33 51.3137 35.6863 54 39 54H235.281C236.738 54 238.146 53.4695 239.241 52.5077L260.869 33.5077C263.589 31.1181 263.589 26.8819 260.869 24.4923L239.241 5.49234C238.146 4.53046 236.738 4 235.281 4H39C35.6863 4 33 6.68629 33 10Z" fill="#DB2727"/>
        </svg>
      ...
      <div className="relative w-[270px] h-[58px]">
        ...
        >
          ...
          <path d="M33 4V54H29C15.1929 54 4 42.8071 4 29C4 15.1929 15.1929 4 29 4H33Z" fill="#C0C0C0"/>
          <path d="M33 10V48C33 51.3137 35.6863 54 39 54H235.281C236.738 54 238.146 53.4695 239.241 52.5077L260.869 33.5077C263.589 31.1181 263.589 26.8819 260.869 24.4923L239.241 5.49234C238.146 4.53046 236.738 4 235.281 4H39C35.6863 4 33 6.68629 33 10Z" fill="#C0C0C0"/>
        </svg>
        <span className="absolute inset-0 flex items-center justify-center text-white font-semibold text-[16px] montserrat">
          Ongoing
        </span>
      ...
      <div className="relative w-[270px] h-[58px]">
        ...
        >
          ...
          <path d="M4 4H241C254.807 4 266 15.1929 266 29C266 42.8071 254.807 54 241 54H4V4Z" fill="#C0C0C0"/>
        </svg>
        <span className="absolute inset-0 flex items-center justify-center text-white font-semibold text-[16px] montserrat">
          Won/Lost
        </span>
