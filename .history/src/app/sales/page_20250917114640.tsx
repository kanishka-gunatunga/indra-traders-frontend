...
export default function SalesDashboard() {
  ...
  { id: "ITPL122455874565", priority: 2, user: "Sophie", phone: "0771234567", date: "12 Mar, 2025" },
  { id: "ITPL122455874566", priority: 0, user: "Alex", phone: "0777654321", date: "13 Mar, 2025" },
  // ... more dummy data
];
  return (
        ...
        <section className="relative bg-[#FFFFFF4D] bg-opacity-30 rounded-[45px] px-9 py-10 flex flex-col justify-center items-center">
          <div className="w-full flex justify-between items-center">
            ...
            <button className="w-12 h-12 bg-white rounded-full shadow flex items-center justify-center">
                <Image src={"/images/sales/plus.svg"} width={24} height={24} alt="Plus icon"/>
            </button>
          </div>
