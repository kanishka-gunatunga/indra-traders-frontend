...
export default function FlowBar({ status, onStatusChange }: FlowBarProps) {
  ...
  const MaskedSVG = ({ src, color }: { src: string; color: string }) => (
    <div
      className="w-[262px] h-[50px] max-w-full"
      style={{
  ...
  return (
    <div className="flex flex- justify-center gap-4 max-w-[1000px] mx-auto">
      {/* Step 1: New */}
      <div className="relative w-[262px] -mr-14 max-[1000px]:mr-0">
      ...
      {/* Step 2: Ongoing */}
      <div className="relative w-[262px] -mr-[54px] max-[1000px]:mr-0">
        <MaskedSVG
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative">
            <select
              ...
              className={`appearance-none bg-transparent text-white font-semibold text-[16px] pr-6 cursor-pointer rounded-md py-1 pl-2 focus:outline-none focus:ring-2 focus:ring-red-500 ${
