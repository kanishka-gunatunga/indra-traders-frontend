...
export default function FlowBar({ status, onStatusChange }: FlowBarProps) {
  ...
  return (
    <div className="flex flex-wrap md:flex-nowrap w-full max-w-[800px] gap-2">
      {/* New */}
      <div className="relative bg-yellow-700 flex-1 flex justify-center items-center -mr-6">
        <svg
          width="271"
          height="58"
          viewBox="0 0 271 58"
      ...
      {/* Ongoing */}
      <div className="relative flex-1 flex bg-red-600 justify-center items-center -mr-6">
        <svg
          width="271"
          height="58"
          viewBox="0 0 271 58"
