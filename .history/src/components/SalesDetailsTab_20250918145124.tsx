  ...
  return (
    <div className="w-full relative">
      ...
      <div className="mt-4">
        ...
        {activeTab === 1 && (
          <div className="mt-8 bg-white rounded-4xl py-8 px-8 relative h-[200px] min-w-0">
            {/* Scrolling element — this must have the no-scrollbar class */}
            <div className="h-full overflow-y-auto overflow-x-hidden no-scrollbar pr-2">
              {/* Table header (this can be wider than container) */}
