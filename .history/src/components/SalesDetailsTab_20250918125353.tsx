...
export default function SalesDetailsTab({status:string}) {
      ...
      <div className="mt-4">
        {activeTab === 0 && (
          <div className="mt-8 bg-white rounded-4xl py-8 px-8 relative">
            ...
            {/* Floating Add button */}
            <button className="absolute bottom-4 right-4 w-12 h-12 bg-[#DB2727] rounded-full flex items-center justify-center text-white shadow-lg hover:bg-red-700">
              <FiPlus size={24} />
            </button>
          </div>
        )}
        ...
        {activeTab === 1 && (
          <div className="mt-8">Reminders content goes here.</div>
        )}
        {activeTab === 2 && (
