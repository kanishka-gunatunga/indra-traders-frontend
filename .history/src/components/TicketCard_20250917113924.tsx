  ...
  return (
    <div className="bg-white rounded-xl p-4 shadow mb-4 w-72">
      ...
      <div className="flex items-center mb-1 space-x-2">
        <Image src="/images/sales/user-icon.svg" className="w-5 h-5" alt="User" width={14} height={14}/>
        <span className="text-sm">{user}</span>
      </div>

      {/* Phone info */}
      <div className="flex items-center mb-1 space-x-2">
        <Image src="/images/sales/phone-icon.svg" className="w-5 h-5" alt="Phone" width={14}  height={14}/>
      ...
      <div className="flex items-center space-x-2">
        <Image
          ...
          className="w-5 h-5"
          alt="Calendar" width={14} height={14}
        />
