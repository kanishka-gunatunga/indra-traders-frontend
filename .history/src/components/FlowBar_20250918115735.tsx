...
export default function FlowBar({ status, onStatusChange }: FlowBarProps) {
  ...
  return (
    <div className="w-[686px] flex">
      {/* Step 1: New */}
      <div className="relative w-[262px] bg-amber-900 -mr-6 flex justify-center items-center">
      ...
      {/* Step 2: Ongoing */}
      <div className="relative w-[262px] bg-green-700 -mr-6 flex justify-center items-center">
        <MaskedSVG
